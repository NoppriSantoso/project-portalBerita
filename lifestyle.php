                            ...
                            <tr class="content-beritaTerkini">
                                <td colspan="3">
                                    ...
                                    <div class="dailyNews">
                                        ...
                                        $sql = "select a.*,b.nama_author from tbl_berita a join tbl_author b on a.kode_author = b.kode_author where jenis_berita = '$jenisBeritaEnumLifestyle' order by tgl_publish desc";
                                        $result = $con->query($sql);
