                                ...
                                <td colspan="3">
                                    ...
                                    <div class="dailyNews">
                                        ...
                                        <?php
                                            ...
                                            $sql = "select a.*, b.kode_author, b.nama_author from tbl_berita a join tbl_author b on a.kode_author = b.kode_author where jenis_berita = '$jenisBeritaEnumHealth' order by tgl_publish desc";
                                            $result = $con->query($sql);
