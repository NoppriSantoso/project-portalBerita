    ...
    <table style="height:300px" cellpadding="0">
        <tr>
            <td rowspan="5" class="NavbarKiri" style="color:black; background-color:white;height:100%" padding="0">
                <table style="width:200px" class="listbutton" cellspacing="0" cellpadding="0">
                    <tr>
                    ...
                    <tr>
                        <td class="a" onclick="changePage('../../authentication/login.php')" align="center"><a class="home"><b>Logout</b></a></td>
                        <script>
                            function changePage(url) {
                                window.location.href = url;
                            }
        ...
        <tr>
            <td class="isi" rowspan="1" cellpadding="0">
                <iframe src="Halaman Isi/FormHome/Home.php" style="width:100%"></iframe>
            </td>
        </tr>
        <tr>
